    ...
    <div className="dashboard-container">
      <div className="flex justify-between items-center mb-4">
        <div className="min-w-0">
          ...
          <p className="text-gray-400 text-xs italic mt-1 status-detail">Last updated: {formatDate(lastFetched)}</p>
        ...
        <div className="flex items-center gap-2 shrink-0">
          {paginationLimited && (
            <button
              ...
              className="flex items-center gap-1.5 px-2 py-1.5 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg text-xs transition-colors whitespace-nowrap"
      ...
      <SummaryCards repoInfo={repoInfo} latestMetrics={latestMetrics} onOpenPrTimeline={onOpenPrTimeline} />
