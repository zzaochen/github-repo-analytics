    ...
    <div>
      ...
      <div className="mb-6 flex items-center justify-between gap-2">
        <div className="min-w-0">
          <h2 className={`${bothSidebarsOpen ? 'text-lg' : 'text-2xl'} font-bold text-gray-900 mb-1 flex items-center gap-2`}>
            <svg xmlns="http://www.w3.org/2000/svg" className={`${bothSidebarsOpen ? 'h-5 w-5' : 'h-6 w-6'} text-orange-500 shrink-0`} viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className={`flex items-center ${bothSidebarsOpen ? 'text-xs' : 'text-sm'} shrink-0`}>
          <span className="text-gray-500 mr-2">{bothSidebarsOpen ? '' : 'Sort by:'}</span>
          <button
            onClick={() => setSortBy('starsGained')}
            className={`${bothSidebarsOpen ? 'px-2' : 'px-3'} py-1 rounded-l-lg border transition-colors ${
              sortBy === 'starsGained'
                ? 'bg-blue-500 text-white border-blue-500'
                : 'bg-white text-gray-600 border-gray-300 hover:bg-gray-50'
            }`}
          >
            {bothSidebarsOpen ? 'Added' : 'Stars Added'}
          </button>
          <button
            onClick={() => setSortBy('percentChange')}
            className={`${bothSidebarsOpen ? 'px-2' : 'px-3'} py-1 border-t border-r border-b border-l border-l-gray-200 -ml-px transition-colors ${
          ...
          <button
            ...
            className={`${bothSidebarsOpen ? 'px-2' : 'px-3'} py-1 rounded-r-lg border-t border-r border-b border-l border-l-gray-200 -ml-px transition-colors ${
              sortBy === 'stars'
                ? 'bg-blue-500 text-white border-blue-500 border-l-gray-200'
                : 'bg-white text-gray-600 border-gray-300 hover:bg-gray-50'
            }`}
          >
            {bothSidebarsOpen ? 'Total' : 'Total Stars'}
          </button>
        </div>
      </div>
