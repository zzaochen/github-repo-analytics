        ...
        <div className={`bg-white border-b border-gray-200 px-3 h-10 flex items-center shrink-0 fixed top-0 z-30 transition-all duration-300 ${sidebarOpen ? 'left-64 xl:left-80' : 'left-0'} ${compact ? 'right-80 xl:right-96' : 'right-0'}`}
          <div className="flex items-center justify-between w-full gap-2">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <Link
                to="/"
                onClick={() => { setSidebarOpen(false); setChatOpen(false); setPrTimelineOpen(false); }}
                className={`${compact ? 'text-sm' : 'text-base xl:text-lg'} font-bold text-gray-900 hover:text-blue-600 transition-colors flex items-center gap-2`}
              >
        ...
        <div className={`w-80 xl:w-96 h-screen bg-white border-l border-gray-200 fixed right-0 top-0 flex flex-col transition-transform duration-300 z-40 ${chatOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex items-center justify-between px-3 h-10 border-b border-gray-200">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold text-gray-800">AI Fetch</h2>
            </div>
            <button
        ...
        <div className={`w-80 xl:w-96 h-screen bg-white border-l border-gray-200 fixed right-0 top-0 flex flex-col transition-transform duration-300 z-40 ${prTimelineOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex items-center justify-between px-3 h-10 border-b border-gray-200">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-sm font-semibold text-gray-800">PR History</h2>
              <button
