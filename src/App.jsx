  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 flex">
      ...
      <div className="flex-1 min-w-0 overflow-hidden">
        ...
        <div className="bg-white border-b border-gray-200 px-3 py-2">
          <div className="flex items-center justify-between w-full gap-2">
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <Link to="/" className="text-sm xl:text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors flex items-center gap-2">
            ...
            <nav className="flex items-center gap-1.5 lg:gap-3 min-w-0">
              ...
              >
                <span className="hidden lg:inline">Repo </span>Lookup
              </Link>
              <Link
                to="/compare"
                className={`text-xs lg:text-sm font-medium transition-colors whitespace-nowrap ${
              ...
              >
                <span className="hidden lg:inline">Metrics </span>Compare
              </Link>
              <Link
                to="/trending"
                className={`text-xs lg:text-sm font-medium transition-colors whitespace-nowrap ${
              ...
              {!chatOpen && (
                <button
                  ...
                  className="pl-2 lg:pl-4 border-l border-gray-200 flex items-center gap-1 lg:gap-2 text-xs lg:text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors"
                  title="Open AI Fetch"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                  </svg>
                  <span className="hidden lg:inline">AI Fetch</span>
                </button>
              )}
              {/* Auth Button */}
              {user ? (
                ...
                <button
                  onClick={handleSignIn}
                  disabled={authLoading}
                  className="pl-2 lg:pl-4 border-l border-gray-200 flex items-center gap-1 lg:gap-2 text-xs lg:text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors disabled:opacity-50"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className={`${sidebarOpen && (chatOpen || prTimelineOpen) ? 'max-w-5xl' : sidebarOpen || chatOpen || prTimelineOpen ? 'max-w-7xl' : 'max-w-[1600px]'} mx-auto px-4 lg:px-8 py-4 lg:py-8`}>
          <Routes>
