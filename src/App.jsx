            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center px-4">
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 w-full">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Sign in with GitHub to access batch fetch and refresh features.
                </p>
                <button
            ...
            <nav className="flex items-center gap-4">
              ...
              {user ? (
                ...
                <button
                  onClick={handleSignIn}
                  disabled={authLoading}
                  className="pl-4 border-l border-gray-200 flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors disabled:opacity-50"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
